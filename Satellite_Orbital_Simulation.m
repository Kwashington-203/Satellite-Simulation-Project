...
%% Task 3 
% Use function read input and satellite to obtain the trajectories for all satellites (ID: 0001-0520) 
% in the satellite data.txt file for a duration of Tf = 6,000s. 
...
grid on; box on; axis equal;
axis(7*[-1 1 -1 1 -1 1]);  
xlabel('x (10^6 m)','FontSize',12); ylabel('y (10^6 m)','FontSize',12); zlabel('z (10^6 m)','FontSize',12); title('All Satellites at Time = 6000s');
set(gca,'LineWidth',1,'FontSize',14,'Xtick',-6:4:6,'Ytick',-6:4:6,'Ztick',-6:4:6);
view(3)
...
grid on; box on; axis equal;
axis(7*[-1 1 -1 1 -1 1]);  
xlabel('x (10^6 m)','FontSize',12); ylabel('y (10^6 m)','FontSize',12); zlabel('z (10^6 m)','FontSize',12); title('All Satellites at Time = 0s');
set(gca,'LineWidth',1,'FontSize',14,'Xtick',-6:4:6,'Ytick',-6:4:6,'Ztick',-6:4:6);
view(3)

exportgraphics(fig, 'images/orbit_all.png', 'Resolution', 300);
